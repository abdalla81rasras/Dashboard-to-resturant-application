                ...
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown mb-3">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            ...
                            <a href="add_burger.php" class="dropdown-item active">Add Burgers</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown mb-3">
           ...
           ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_burger" value="<?php echo $id_burger; ?>">
                    <div class="row g-4">
                        <div class="col-lg-12 col-xl-12">
                            <?php if($update==true): ?>
                                <h3 class="text-secondary alert-link">Update Burger :</h3>
                            <?php else: ?>
                                <h3 class="text-secondary alert-link">Add Burger :</h3>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="bg-secondary rounded align-items-center justify-content-between p-3">
                                <div class="form-floating">
                                    <input type="text" name="burger_name" value="<?php echo htmlspecialchars($burger_name); ?>" class="form-control" id="floatingInput" placeholder=" ">
                                    <label for="floatingInput">Burger Name</label>
                                    <div class="text-primary mt-1"><?php echo $errors['burger_name'] ?></div>
                                </div>                            
                            </div>
                        </div>
                    </div>
                    <div class="row g-4 my-3">
                        <div class="col-lg-6 col-xl-6">
                            <div class="bg-secondary rounded align-items-center justify-content-between p-3">
                                <div class="form-floating">
                                    <input type="number" name="burger_meal_price" value="<?php echo htmlspecialchars($burger_meal_price); ?>" class="form-control" min="0" step="0.00001" id="floatingInput" placeholder=" ">
                                    <label for="floatingInput">Burger Meal Price ( JOD )</label>
                                    <div class="text-primary mt-1"><?php echo $errors['burger_meal_price'] ?></div>
                                </div>                            
                            </div>
                        </div>
                    </div>
                    <div class="row g-4 my-3">
                        <div class="col-lg-6 col-xl-6">
                            <div class="bg-secondary rounded align-items-center justify-content-between p-3">
                                <div class="form-floating">
                                    <input type="number" name="burger_sandwich_price" value="<?php echo htmlspecialchars($burger_sandwich_price); ?>" min="0" step="0.00001" class="form-control" id="floatingInput" placeholder=" ">
                                    <label for="floatingInput">Burger Sandwich Price ( JOD )</label>
                                    <div class="text-primary mt-1"><?php echo $errors['burger_sandwich_price'] ?></div>
                                </div>                            
                            </div>                    
                        </div>
                    </div>
                    <div class="row g-4 justify-content-around mt-2 mb-2">
                        <div class="col-md-2 col-xl-2">
                            <?php if($update==true): ?>
                                <button name="update_burger" class="btn btn-secondary m-2 w-100 h-100 alert-link">Update</button>
                            <?php else: ?>
                                <button name="save_burger" class="btn btn-secondary m-2 w-100 h-100 alert-link">Save</button>
                            <?php endif; ?>
                        </div>
                        <div class="col-md-2 col-xl-2">
                            <button name="cansel_burger" class="btn btn-secondary m-2 w-100 h-100 alert-link">Cansel</button>
                        </div>
                    </div>
                </form>            
            </div>
