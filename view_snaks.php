...
?>
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown mb-3">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            <a href="view_snaks.php" class="dropdown-item mb-1 active">View Snaks</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="col-sm-6 col-xl-6">
                            <h3 class="text-secondary alert-link">View Snaks :</h3>
                        </div>
                    </div>
                <div class="row mt-4">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Snack Meal Price</th>
                                        <th scope="col">Snack Sandwich Price</th>
                                        <th scope="col">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
                                        $select="SELECT * FROM `snaks`";
                                        $query=mysqli_query($conn , $select);
                                        while($row=mysqli_fetch_assoc($query)):
                                    ?>
                                        <tr>
                                            <td><?php echo $row['snack_name']; ?></td>
                                            <td><?php echo $row['snack_meal_price']; ?> JOD</td>
                                            <td><?php echo $row['snack_sandwich_price']; ?> JOD</td>
                                            <td>
                                                <a href="add_snaks.php?edit_snaks=<?php echo $row['id_snaks']; ?>" ><i class="fa fa-edit" title="edit"></i></a> |   
                                                <a href="add_snaks.php?delete_snaks=<?php echo $row['id_snaks']; ?>" ><i class="fa fa-window-close" title="delete"></i></a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                </tbody>
